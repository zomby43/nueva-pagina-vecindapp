          ...
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <div>
                  <h6 className="text-muted mb-0 fw-normal">Balance Actual</h6>
          ...
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <div>
                  <h6 className="text-muted mb-0 fw-normal">Ingresos {balanceAño?.año}</h6>
          ...
          <div className="card border-0 shadow-sm h-100">
            <div className="card-body">
              <div className="d-flex align-items-center mb-3">
                ...
                <div>
                  <h6 className="text-muted mb-0 fw-normal">Egresos {balanceAño?.año}</h6>
                  <small className="text-muted">Total del año</small>
                </div>
              </div>
              ...
              <div className="card-body">
                <div className="mb-3">
                  <div className="d-flex justify-content-between mb-2">
                    ...
                    <span className="fw-bold">{formatCurrency(balanceAño.saldo_inicial)}</span>
                  </div>
                  <div className="d-flex justify-content-between mb-2">
