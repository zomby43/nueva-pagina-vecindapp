...
} else if (!globalThis.telegramCommandsRegistered) {
  // Solo registrar comandos si no se han registrado antes
...
*Notificaciones:* ${usuario.preferencia_notificacion === 'telegram' ? '📱 Telegram' : usuario.preferencia_notificacion === 'email' ? '📧 Email' : '📧 Email + 📱 Telegram'}`;
