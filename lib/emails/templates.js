...
Equipo VecindApp
  ...
  // ============================================
  // TEMPLATES PARA NOTICIAS Y AVISOS
  // ============================================

  nueva_noticia: (nombreCompleto, tituloNoticia, resumen, categoria, urlNoticia) => {
    const categorias = {
      general: 'General',
      eventos: 'Eventos',
      obras: 'Obras',
    ...
    const categoriaTexto = categorias[categoria] || categoria;

    return {
      asunto: '📰 Nueva noticia: ' + tituloNoticia,
      html: `
        <!DOCTYPE html>
        <html lang="es">
        <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Nueva Noticia - VecindApp</title>
        </head>
        <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f4f4; padding: 20px;">
            <tr>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      <div style="text-align: center; margin-bottom: 30px;">
                        <div style="font-size: 60px; margin-bottom: 20px;">📰✨</div>
                        <h2 style="color: #154765; margin: 0 0 10px 0; font-size: 24px;">¡Nueva Noticia Publicada!</h2>
                      </div>
                      ...
                      <p style="color: #333333; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
                        Tu Junta de Vecinos ha publicado una nueva noticia que te puede interesar:
                      </p>

                      <div style="background-color: #e8f4f5; border-left: 4px solid #439fa4; padding: 20px; margin: 25px 0; border-radius: 4px;">
                        <h3 style="color: #154765; font-size: 20px; margin: 0 0 10px 0;">${tituloNoticia}</h3>
                        <p style="color: #439fa4; font-size: 14px; margin: 0 0 15px 0; font-weight: 600;">
                          <span style="background-color: #439fa4; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px;">${categoriaTexto}</span>
                        </p>
                        ${resumen ? `<p style="color: #154765; font-size: 15px; margin: 0; line-height: 1.6;">${resumen}</p>` : ''}
                      </div>
                      ...
                      <p style="color: #666666; font-size: 14px; line-height: 1.6; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eeeeee;">
                        Mantente informado de todo lo que sucede en tu comunidad.
                      </p>
                    </td>
                  </tr>
...
Equipo VecindApp
  ...
  nuevo_aviso: (nombreCompleto, tituloAviso, mensajeAviso, tipo, prioridad, urlAviso) => {
    const tipos = {
    ...
    const tipoTexto = tipos[tipo] || tipo;
    ...
    const prioridadTexto = prioridades[prioridad] || prioridad;

    // Seleccionar emoji y color según el tipo
    let emoji = '📢';
    let colorBorde = '#439fa4';
    let colorBg = '#e8f4f5';

    if (tipo === 'urgente' || prioridad === 'critica') {
      emoji = '🚨';
      colorBorde = '#f44336';
      colorBg = '#ffebee';
    ...
    return {
      asunto: `${emoji} ${prioridad === 'critica' || prioridad === 'alta' ? 'IMPORTANTE - ' : ''}${tituloAviso}`,
      html: `
        <!DOCTYPE html>
        <html lang="es">
        <head>
          <meta charset="UTF-8">
          <meta name="viewport" content="width=device-width, initial-scale=1.0">
          <title>Nuevo Aviso - VecindApp</title>
        </head>
        <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
          <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f4f4; padding: 20px;">
            <tr>
                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      <div style="text-align: center; margin-bottom: 30px;">
                        ...
                        <h2 style="color: #154765; margin: 0 0 10px 0; font-size: 24px;">Nuevo Aviso</h2>
                      </div>
                      ...
                      <p style="color: #333333; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
                        Tu Junta de Vecinos ha publicado un nuevo aviso:
                      </p>

                      <div style="background-color: ${colorBg}; border-left: 4px solid ${colorBorde}; padding: 20px; margin: 25px 0; border-radius: 4px;">
                        <div style="margin-bottom: 10px;">
                          <span style="background-color: ${colorBorde}; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px; margin-right: 8px;">${tipoTexto}</span>
                          <span style="background-color: ${prioridad === 'critica' || prioridad === 'alta' ? '#f44336' : '#ffc107'}; color: white; padding: 4px 12px; border-radius: 12px; font-size: 12px;">Prioridad: ${prioridadTexto}</span>
                        </div>
                        <h3 style="color: #154765; font-size: 20px; margin: 15px 0 10px 0;">${tituloAviso}</h3>
                        <p style="color: #154765; font-size: 15px; margin: 0; line-height: 1.6; white-space: pre-wrap;">${mensajeAviso}</p>
                      </div>

                      <div style="text-align: center; margin: 30px 0;">
                        <a href="${urlAviso}"
                           style="display: inline-block; background-color: ${colorBorde}; color: #ffffff; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: bold; font-size: 16px;">
                          Ver Aviso Completo
                        </a>
                      </div>

                      <p style="color: #666666; font-size: 14px; line-height: 1.6; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eeeeee;">
                        Mantente al tanto de los avisos importantes de tu comunidad.
                      </p>
                    </td>
                  </tr>
...
${emoji} Nuevo Aviso ${prioridad === 'critica' || prioridad === 'alta' ? '- IMPORTANTE' : ''}
